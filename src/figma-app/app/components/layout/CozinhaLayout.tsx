  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden fi-page-shell">
      ...
      >
        <div className="px-6 py-6 border-b border-gray-700">
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-100 text-xs" style={{ fontWeight: 500 }}>Fábrica</p>
            </div>
          </button>
          <a
        ...
        <div className="px-6 py-4 border-b border-gray-700">
          <div className="flex items-center gap-2">
            <ChefHat className="w-4 h-4 text-gray-100" aria-hidden="true" focusable="false" />
            <p className="text-gray-100 text-sm" style={{ fontWeight: 500 }}>
              {currentUser?.name || "Painel da Fábrica"}
            </p>
          </div>
        </div>

        <nav className="flex-1 px-3 py-4" aria-label="Menu da fábrica">
      ...
      <main
        ...
        tabIndex={-1}
        aria-label="Conteúdo da fábrica"
      >
        <Outlet />
      </main>
    </div>
