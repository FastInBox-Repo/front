...
type Role = "nutricionista" | "paciente" | "cozinha" | "admin";
...
const roleConfig: Record<Role, { label: string; redirect: string; description: string }> = {
  ...
  paciente: {
    label: "Paciente",
    redirect: "/paciente",
    description: "Acesse seus pedidos e histórico",
  },
  cozinha: {
    label: "Cozinha",
  ...
  admin: {
    ...
    description: "Monitoramento da operação",
  },
};
...
export default function LoginPage() {
  ...
  const defaultRole = (searchParams.get("role") as Role) || "nutricionista";
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 text-sm">Selecione seu perfil e faça login</p>
          </div>
